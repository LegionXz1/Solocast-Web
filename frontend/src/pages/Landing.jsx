      ...
      <div className="features-bento">
        <div className="doppel-shell feature-card">
          <div className="doppel-core">
            <h3 className="feature-title">⚡ ไร้ความหน่วง (Zero Latency)</h3>
        ...
        <div className="doppel-shell feature-card">
          <div className="doppel-core">
            <h3 className="feature-title">🎨 ปรับแต่งง่ายดาย (Easy Customization)</h3>
        ...
        <div className="doppel-shell feature-card full-width">
          <div className="doppel-core">
            <h3 className="feature-title">💎 เอ็กซ์คลูซีฟดีไซน์โดยทีมงาน (Exclusive Designs)</h3>
