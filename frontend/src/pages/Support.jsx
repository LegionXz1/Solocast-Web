      ...
      <div className="hero-section" style={{ marginBottom: '1.25rem' }}>
        ...
        <div className="support-tab-group">
          ...
          <a
            ...
            style={{ textDecoration: 'none', color: '#5865F2', display: 'inline-flex', alignItems: 'center', gap: '0.45rem' }}
            title="สอบถามและพูดคุยกับทีมงานสดๆ ใน Discord"
          >
